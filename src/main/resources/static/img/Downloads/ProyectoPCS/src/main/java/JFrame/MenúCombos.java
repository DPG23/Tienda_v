 ...
 * @author Personal
 */
public class MenúCombos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Bhamburguesas.setBackground(new java.awt.Color(153, 153, 153));
        Bhamburguesas.setText("Hamburguesas");
        Bhamburguesas.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(204, 204, 204)
                        .addComponent(Bhamburguesas, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(Bhamburguesas, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void BHBSENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHBSENActionPerformed
        JOptionPane.showMessageDialog(null,"¡Se ha agregado un combo de hamburguesa sencilla a su compra!");
        Opcion o = new Opcion();
        o.setVisible(true);
        this.dispose();
    ...
    private void BHBCASAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHBCASAActionPerformed
        JOptionPane.showMessageDialog(null,"¡Se ha agregado un combo de hamburguesa de la casa a su compra!");
        Opcion o = new Opcion();
        o.setVisible(true);
        this.dispose();
    ...
    private void BHBTAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHBTAActionPerformed
        JOptionPane.showMessageDialog(null,"¡Se ha agregado un combo de Tocinoburguesa a su compra!");
        Opcion o = new Opcion();
        o.setVisible(true);
        this.dispose();
    ...
    private void BHBDCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHBDCActionPerformed
        JOptionPane.showMessageDialog(null,"¡Se ha agregado un combo de hamburguesa doble carne a su compra!");
        Opcion o = new Opcion();
        o.setVisible(true);
        this.dispose();
    ...
    private void BHBDXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHBDXActionPerformed
        JOptionPane.showMessageDialog(null,"¡Se ha agregado un combo de hamburguesa deluxe a su compra!");
        Opcion o = new Opcion();
        o.setVisible(true);
        this.dispose();
    ...
    private void BHBEQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHBEQActionPerformed
        JOptionPane.showMessageDialog(null,"¡Se ha agregado un combo de hamburguesa extra queso a su compra!");
        Opcion o = new Opcion();
        o.setVisible(true);
        this.dispose();
